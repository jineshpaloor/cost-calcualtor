...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MonthlyUserBill'
        db.create_table(u'costmanager_monthlyuserbill', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('total_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2)),
            ('amount_spend', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2)),
            ('amount_to_pay', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2)),
            ('billing_date', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'costmanager', ['MonthlyUserBill'])


    def backwards(self, orm):
        # Deleting model 'MonthlyUserBill'
        db.delete_table(u'costmanager_monthlyuserbill')
    ...
    models = {
        ...
        u'costmanager.monthlyuserbill': {
            ...
            'amount_spend': ('django.db.models.fields.DecimalField', [], {'max_digits': '7', 'decimal_places': '2'}),
            'amount_to_pay': ('django.db.models.fields.DecimalField', [], {'max_digits': '7', 'decimal_places': '2'}),
            'billing_date': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'total_amount': ('django.db.models.fields.DecimalField', [], {'max_digits': '7', 'decimal_places': '2'}),
