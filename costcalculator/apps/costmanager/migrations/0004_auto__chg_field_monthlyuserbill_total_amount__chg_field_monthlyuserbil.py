...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MonthlyUserBill.total_amount'
        db.alter_column(u'costmanager_monthlyuserbill', 'total_amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2))

        # Changing field 'MonthlyUserBill.amount_to_pay'
        db.alter_column(u'costmanager_monthlyuserbill', 'amount_to_pay', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2))

        # Changing field 'MonthlyUserBill.amount_spend'
        db.alter_column(u'costmanager_monthlyuserbill', 'amount_spend', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'MonthlyUserBill.total_amount'
        db.alter_column(u'costmanager_monthlyuserbill', 'total_amount', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=7, decimal_places=2))

        # Changing field 'MonthlyUserBill.amount_to_pay'
        db.alter_column(u'costmanager_monthlyuserbill', 'amount_to_pay', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=7, decimal_places=2))

        # Changing field 'MonthlyUserBill.amount_spend'
        db.alter_column(u'costmanager_monthlyuserbill', 'amount_spend', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=7, decimal_places=2))
    ...
    models = {
        ...
        u'costmanager.monthlyuserbill': {
            ...
            'billing_date': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
