...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MonthlyUserBill.billing_from'
        db.add_column(u'costmanager_monthlyuserbill', 'billing_from',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 28, 0, 0)),
                      keep_default=False)

        # Adding field 'MonthlyUserBill.billing_to'
        db.add_column(u'costmanager_monthlyuserbill', 'billing_to',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 28, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MonthlyUserBill.billing_from'
        db.delete_column(u'costmanager_monthlyuserbill', 'billing_from')

        # Deleting field 'MonthlyUserBill.billing_to'
        db.delete_column(u'costmanager_monthlyuserbill', 'billing_to')
