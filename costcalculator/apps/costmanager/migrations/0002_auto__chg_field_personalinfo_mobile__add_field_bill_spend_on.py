...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PersonalInfo.mobile'
        db.alter_column(u'costmanager_personalinfo', 'mobile', self.gf('django.db.models.fields.CharField')(max_length=15))
        # Adding field 'Bill.spend_on'
        db.add_column(u'costmanager_bill', 'spend_on',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 2, 22, 0, 0)),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PersonalInfo.mobile'
        db.alter_column(u'costmanager_personalinfo', 'mobile', self.gf('django.db.models.fields.IntegerField')())
        # Deleting field 'Bill.spend_on'
        db.delete_column(u'costmanager_bill', 'spend_on')
